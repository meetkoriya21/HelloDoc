  ...
  const updateUserProfileData = async () => {
    try {
      ...
      if(data.success){
        ...
        await loadUserProfileData(); // refresh user data from DB
        setIsEdit(false);
        setImage(false)
      }else{
    ...
    userData && (
      <div className="max-w-lg flex flex-col gap-2 text-sm">
        ...
        <div className="mt-10">
          {isEdit ? (
            <button
              className="border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all coursor-pointer duration-500"
...
//         toast.success("Profile updated successfully!");
//         setIsEdit(false);
//         loadUserProfileData(); // refresh user data from DB
//       } else {
//         toast.error(data.message);
//       }
//     } catch (error) {
